...
public class BuildingCrafter : MonoBehaviour
{
    ...
    private SurivivalStats surivivalStats;          //생존 스탯 참조
    ...
    public void TryCraft(CraftingRecipe recipe, PlayerInventory inventory)      //아이템 제작 시도
    {
        ...
        {
            FloatingTextManager.instance?.Show("건설이 완료되지 않았습니다!", transform.position + Vector3.up);
            return;
        }
        ...
        surivivalStats.DamageCrafting();        //우주복 내구도 감소
